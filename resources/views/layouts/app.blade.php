...
<head>
    ...
    <style>
        ...
        /* Sidebar responsive — CSS-driven to avoid Tailwind CDN dynamic class issues */
        #app-sidebar { transition: width 0.3s ease, transform 0.3s ease; }
        @media (max-width: 1023px) {
            #app-sidebar { width: 280px !important; transform: translateX(-100%); }
            #app-sidebar.mobile-open { transform: translateX(0); }
        }
        @media (min-width: 1024px) {
            #app-sidebar { transform: translateX(0) !important; }
            #app-sidebar.desktop-expanded { width: 256px; }
            #app-sidebar.desktop-collapsed { width: 64px; }
...
<aside id="app-sidebar"
       :class="{ 'mobile-open': mobileSidebarOpen, 'desktop-expanded': sidebarOpen, 'desktop-collapsed': !sidebarOpen }"
       class="fixed inset-y-0 left-0 bg-gradient-to-b from-slate-800 to-slate-900 text-white z-30 flex flex-col">

    <!-- Logo -->
    <div class="flex items-center justify-between px-4 py-4 border-b border-slate-700 min-h-[65px] flex-shrink-0">
        <div class="flex items-center gap-3 min-w-0">
            ...
            <div x-show="sidebarOpen || mobileSidebarOpen" class="overflow-hidden">
                <div class="font-bold text-sm leading-tight whitespace-nowrap">{{ config('app.short_title', 'WHR-ePIS') }}</div>
                <div class="text-xs text-slate-400 leading-tight">Demo v1.0</div>
            </div>
        </div>
        <!-- Mobile close button -->
        <button @click="mobileSidebarOpen=false" class="lg:hidden flex-shrink-0 p-1.5 rounded-lg hover:bg-slate-700 text-slate-400 hover:text-white">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-2"
         @click="if ($event.target.tagName === 'A' || $event.target.closest('a')) mobileSidebarOpen = false">

        <!-- Main Dashboard -->
        <div x-show="sidebarOpen || mobileSidebarOpen" class="px-2 py-1 text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1">Main</div>
        ...
        <a href="{{ route('warehouse.dashboard') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('warehouse.dashboard') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Dashboard</span>
        </a>
        <a href="{{ route('warehouse.inventory') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('warehouse.inventory') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Inventory</span>
        </a>
        <a href="{{ route('warehouse.receiving') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('warehouse.receiving') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Penerimaan Barang</span>
        </a>
        <a href="{{ route('warehouse.issuing') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('warehouse.issuing') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Pengeluaran Barang</span>
        </a>
        <a href="{{ route('warehouse.stock-movement') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('warehouse.stock-movement') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Mutasi Stok</span>
        </a>
        <a href="{{ route('warehouse.reports') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('warehouse.reports') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Laporan Stok</span>
        </a>
        <a href="{{ route('warehouse.surat-jalan') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('warehouse.surat-jalan*') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Surat Jalan</span>
        </a>
        <a href="{{ route('warehouse.req-atk') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('warehouse.req-atk*') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Req ATK</span>
        </a>

        <!-- HR Module -->
        <div x-show="sidebarOpen || mobileSidebarOpen" class="px-2 py-1 text-xs font-semibold text-slate-400 uppercase tracking-wider mt-3 mb-1">Human Resource</div>
        ...
        <a href="{{ route('hr.employees') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('hr.employees*') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Data Karyawan</span>
        </a>
        <a href="{{ route('hr.attendance') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('hr.attendance') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Absensi</span>
        </a>
        <a href="{{ route('hr.payroll') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('hr.payroll') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Payroll</span>
        </a>
        <a href="{{ route('hr.reports') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('hr.reports') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Laporan HR</span>
        </a>
        <a href="{{ route('hr.leaves') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('hr.leaves*') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Pengajuan Cuti</span>
        </a>
        <a href="{{ route('hr.sick-leaves') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('hr.sick-leaves*') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Pengajuan Sakit</span>
        </a>
        <a href="{{ route('hr.overtime') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('hr.overtime*') ? 'active' : '' }}">
            <svg class="w-5 h-5 flex-shrink-0 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Pengajuan Lembur</span>
        </a>
        <a href="{{ route('hr.leave-reports') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('hr.leave-reports') ? 'active' : '' }}">
            <svg class="w-5 h-5 flex-shrink-0 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Laporan Cuti/Sakit/Lembur</span>
        </a>
        <a href="{{ route('hr.izin') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('hr.izin*') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Form Izin</span>
        </a>
        <a href="{{ route('hr.pengajuan-dinas') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('hr.pengajuan-dinas*') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Pengajuan Dinas</span>
        </a>
        <a href="{{ route('hr.pengajuan-spj') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('hr.pengajuan-spj*') ? 'active' : '' }}">
            <svg class="w-5 h-5 flex-shrink-0 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Pengajuan SPJ</span>
        </a>
        <a href="{{ route('hr.tunjangan') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('hr.tunjangan*') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Laporan Tunjangan</span>
        </a>

        <!-- Procurement Module -->
        <div x-show="sidebarOpen || mobileSidebarOpen" class="px-2 py-1 text-xs font-semibold text-slate-400 uppercase tracking-wider mt-3 mb-1">eProcurement</div>
        ...
        <a href="{{ route('procurement.purchase-requests') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('procurement.purchase-requests*') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Purchase Request</span>
        </a>
        <a href="{{ route('procurement.approvals') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('procurement.approvals') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Approval</span>
        </a>
        <a href="{{ route('procurement.reports') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('procurement.reports') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Laporan Pengadaan</span>
        </a>
        <a href="{{ route('procurement.material-request') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('procurement.material-request*') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Material Request</span>
        </a>
        <a href="{{ route('procurement.purchase-order') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('procurement.purchase-order*') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Purchase Order</span>
        </a>

        {{-- Aset IT Module --}}
        <div x-show="sidebarOpen || mobileSidebarOpen" class="px-2 py-1 text-xs font-semibold text-slate-400 uppercase tracking-wider mt-3 mb-1">Aset IT</div>
        ...
        <a href="{{ route('aset-it.assets') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('aset-it.assets*') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Daftar Aset IT</span>
        </a>
        <a href="{{ route('aset-it.assets.create') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('aset-it.assets.create') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Daftarkan Aset</span>
        </a>
        <a href="{{ route('aset-it.history') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('aset-it.history') ? 'active' : '' }}">
            <svg class="w-5 h-5 flex-shrink-0 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">History Aset</span>
        </a>
        <a href="{{ route('aset-it.pengeluaran') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('aset-it.pengeluaran*') ? 'active' : '' }}">
            <svg class="w-5 h-5 flex-shrink-0 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Pengeluaran Aset</span>
        </a>

        {{-- E-Approval Module --}}
        <div x-show="sidebarOpen || mobileSidebarOpen" class="px-2 py-1 text-xs font-semibold text-slate-400 uppercase tracking-wider mt-3 mb-1">E-Approval</div>
        ...
        <a href="{{ route('e-approval.documents') }}"
           class="nav-item flex items-center px-3 py-2.5 rounded-lg mb-1 text-slate-200 hover:text-white transition-colors {{ request()->routeIs('e-approval.documents') ? 'active' : '' }}">
            ...
            <span x-show="sidebarOpen || mobileSidebarOpen" class="ml-3 text-sm">Dokumen Approval</span>
        </a>
    ...
    <div class="px-4 py-3 border-t border-slate-700">
        <button @click="sidebarOpen=!sidebarOpen" class="hidden lg:flex w-full items-center justify-center p-2 rounded-lg hover:bg-slate-700 transition-colors text-slate-400 hover:text-white">
            <svg x-show="sidebarOpen || mobileSidebarOpen" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 19l-7-7 7-7m8 14l-7-7 7-7"/></svg>
...
<!-- Main Content -->
<div :class="{ 'main-expanded': sidebarOpen, 'main-collapsed': !sidebarOpen }" class="sidebar-transition min-h-screen flex flex-col">
